...
export const site = {
  name: "GETESy的Blog",
  desc: "分享一些教程和日记",
  url: "https://blog.getesy.top",
  avatar: "https://blog.getesy.top/_astro/GETESy.D9z6DM4s_ZAy1j.webp",
  email: "yi20112011yi1@outlook.com",
};
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div>
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">7个工作日内，确认信息无误后会尽快添加您的友链</p>
            </div>
          </div>
        </div>
      </div>
